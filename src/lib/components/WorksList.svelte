...
>
	...
	<div class="px-6 md:px-24 max-w-7xl mx-auto flex flex-col">
		...
		{#each works as work}
			...
			>
				<div
					class="absolute inset-0 bg-linear-to-r from-[#E6FF5A]/0 via-[#E6FF5A]/5 to-[#E6FF5A]/0 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 pointer-events-none"
				></div>
		...
		<div class="mt-16 flex justify-center w-full">
			...
			>
				View All Archives & Case Studies
			</a>
		</div>
	</div>
</section>
