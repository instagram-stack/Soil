	...
	const feedbacks = [
		{
			name: "Sarah Jenkins",
			role: "CMO, Lumina",
			text: "Soil Studio didn't just build a website; they architected a digital reality. Their motion mastery and craftsmanship are unmatched.",
		},
		{
			name: "Marcus Thorne",
			role: "Founder, Nexal",
...
>
	...
	<div
		class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[800px] h-[500px] bg-[#E6FF5A]/5 blur-[200px] rounded-full pointer-events-none"
	></div>
