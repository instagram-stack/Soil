    ...
    >
        ...
        >
            ...
            <div class="overflow-hidden pb-8 -mb-8">
                <div
                    bind:this={words[1]}
                    class="flex items-center gap-2 sm:gap-3 will-change-transform pt-4"
                >
                    <span class="italic text-white/50 font-serif">starts</span>
                    <span>somewhere.</span>
                </div>
            </div>
        </h1>
        ...
        <div bind:this={ctaContainer} class="mt-8 flex gap-4 z-20">
            <a
                href="/work"
                class="px-8 py-4 bg-white text-black rounded-full font-sans font-medium hover:bg-[#E6FF5A] hover:text-black transition-all duration-500 cursor-pointer shadow-[0_0_40px_rgba(255,255,255,0.15)] inline-block"
            >
                View Selected Works
            </a>
            <a
                href="/services"
                class="hidden md:inline-block px-8 py-4 bg-transparent text-white border border-white/20 rounded-full font-sans font-medium hover:bg-[#E6FF5A] hover:border-[#E6FF5A] hover:text-black transition-all duration-500 cursor-pointer"
            >
                Our Services
            </a>
        </div>
