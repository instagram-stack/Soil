import { S as writable, kt as __commonJSMin, x as readable } from "./chunks/index-server.js";
import { _ as noop, a as split_remote_key, c as validate_depends, f as get_status, g as text_encoder, h as get_relative_path, i as parse_remote_arg, l as validate_load_response, m as base64_encode, n as TRAILING_SLASH_PARAM, o as stringify, p as normalize_error, r as create_remote_key, t as INVALIDATED_PARAM, v as once } from "./chunks/shared.js";
	...
	const cookies = {
		...
		*/
		get(name, opts) {
			...
			const cookie = (0, import_cookie.parse)(header, { decode: opts?.decode })[name];
			if (!cookie) {
